...
@Entity
@IdClass(StudentOut.class)
public class StudentOut implements java.io.Serializable {
	...
	@ApiModelProperty(value = "退學原因", required = true)
	@Column(name = "out_reason_kind", updatable = false, insertable = false)
	public String out_reason_kind;
...
//	
	...
	public String getOut_reason_kind() {
		return out_reason_kind;
	}

	public void setOut_reason_kind(String out_reason_kind) {
		this.out_reason_kind = out_reason_kind;
	}
